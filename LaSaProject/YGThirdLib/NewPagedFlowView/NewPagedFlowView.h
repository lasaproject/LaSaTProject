 ...
 *  @return <#return value description#>
 */
- (void)didSelectCell:(PGIndexBannerSubView *)subView withSubViewIndex:(NSInteger)subIndex;
 ...
 *  @return <#return value description#>
 */
- (PGIndexBannerSubView *)flowView:(NewPagedFlowView *)flowView cellForPageAtIndex:(NSInteger)index;
