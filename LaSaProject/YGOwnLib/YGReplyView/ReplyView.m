...
-(void)configUI
{
    self.frame = CGRectMake(0, DEVICE_SCREEN_HEIGHT, DEVICE_SCREEN_WIDTH, 49);
    ...
    replyTextField.font = [UIFont systemFontOfSize:FONT_BIG_1];
...
-(void)show
{
    ...
    [_coverButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(DEVICE_SCREEN_HEIGHT);
    }];
...
-(void)keyboardWillChangeFrame:(NSNotification *)notification
{
    ...
    [UIView animateWithDuration:0.25 animations:^{
        self.y = DEVICE_SCREEN_HEIGHT - self.height - self.keyboardHeight;
