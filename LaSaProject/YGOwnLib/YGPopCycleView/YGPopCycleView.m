...
-(void)configUI
{
    ...
    _dismissButton = [[UIButton alloc]initWithFrame:CGRectMake(0, DEVICE_SCREEN_HEIGHT - 17 - DEVICE_TAB_BAR_HEIGHT, 53, 53)];
    _dismissButton.centerx = DEVICE_SCREEN_WIDTH/2;
    ...
    for (int i = 0; i<_dataSource.count; i++)
    {
        ...
        [imgButton sizeToFit];
        imgButton.frame = CGRectMake(0, DEVICE_SCREEN_HEIGHT - DEVICE_TAB_BAR_HEIGHT - 56 - imgButton.height, imgButton.width,imgButton.height);
