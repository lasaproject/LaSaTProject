...
-(void)configCameraUI
{
    ...
    _timeLabel.frame = CGRectMake(self.view.frame.size.width - _timeLabel.frame.size.width - DEVICE_STATUS_BAR_HEIGHT, 0, _timeLabel.frame.size.width, _timeLabel.frame.size.height);
...
-(void)videoButtonTouchDownTimer
{
    ...
    [_timeLabel sizeToFit];
    _timeLabel.frame = CGRectMake(self.view.frame.size.width - _timeLabel.frame.size.width - DEVICE_STATUS_BAR_HEIGHT, _timeLabel.frame.origin.y, _timeLabel.frame.size.width, _timeLabel.frame.size.height);
