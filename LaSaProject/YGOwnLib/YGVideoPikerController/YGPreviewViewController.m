...
-(void)configUI
{
    ...
    [xButton sizeToFit];
    xButton.frame = CGRectMake(20, self.view.frame.size.height - DEVICE_STATUS_BAR_HEIGHT - xButton.frame.size.height, xButton.frame.size.width, xButton.frame.size.height);
