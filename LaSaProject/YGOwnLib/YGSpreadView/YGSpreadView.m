...
-(void)configUI
{
    ...
    textLabel.text = @"全部";
    textLabel.font = [UIFont systemFontOfSize:FONT_NORMAL];
    ...
    _gradientLayer.colors = [NSArray arrayWithObjects:(id)[COLOR_WHITE colorWithAlphaComponent:0].CGColor, (id)COLOR_WHITE.CGColor,nil];
