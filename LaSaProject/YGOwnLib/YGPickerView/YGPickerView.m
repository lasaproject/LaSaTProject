...
- (void)OkButtonClick
{
    ...
    if (_handler)
    {
        _handler([_pickerView selectedRowInComponent:0], _pickerViewDataSource
...
{
    UILabel *myView = [[UILabel alloc] initWithFrame:CGRectMake(0.0, 0.0, DEVICE_SCREEN_WIDTH, 30)];
